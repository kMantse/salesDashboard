        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    <?php echo form_open(base_url('admin/branch/edit/'.$branch['branch_id']), 'class="form-horizontal"' )?>
                    ...
                    <div class="form-group">
                        <div class="col-md-11">
                            <input type="submit" name="submit" value="Update Branch" class="btn btn-info pull-right">
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
